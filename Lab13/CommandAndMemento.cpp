...
void DocumentWithHistory::history(){
   ...
   if(doneCommands_.empty()){
      cout << "No commands executed yet." << endl;
   }
...
void DocumentWithHistory::redo(int lineNumber){
   stack<Command*> temp = doneCommands_;
		Command* myCom;
...
int main() {
   ...
   do{
      ...
      case 'r':
         int lineNumber;
         cout << "Enter command you would like to redo: ";
         cin >> lineNumber;
         his.redo(lineNumber);
         break;
      }
